...
void loop(){
  ...
  if(error == 0){  
    ...
    Serial.println((channel_3_assign & 0b00000111) + 3);
    ...
    Serial.println((channel_1_assign & 0b00000111) + 3);
  ...
  if(error == 0){
    ...
    Serial.println((channel_2_assign & 0b00000111) + 3);
  ...
  if(error == 0){
    ...
    Serial.println((channel_4_assign & 0b00000111) + 3);
