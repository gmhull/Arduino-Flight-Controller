...
void setup(){
  ...
  DDRB |= B00001111;                                                                    //Configure digital poort 8, 9, 10 and 11 as output.
...
void esc_pulse_output(){
  zero_timer = micros();
  PORTB |= B00001111;                                            //Set port 8, 9, 10 and 11 high at once
  timer_channel_1 = esc_1 + zero_timer;                          //Calculate the time when digital port 8 is set low.
  timer_channel_2 = esc_2 + zero_timer;                          //Calculate the time when digital port 9 is set low.
  timer_channel_3 = esc_3 + zero_timer;                          //Calculate the time when digital port 10 is set low.
  timer_channel_4 = esc_4 + zero_timer;                          //Calculate the time when digital port 11 is set low.
